...
<template>
  <header class="flex justify-between items-center mb-6 pb-3 border-b border-gray-200 dark:border-gray-700 select-none" data-tauri-drag-region>
    <h1 class="text-gray-800 dark:text-white">局域网文件文本传输</h1>
